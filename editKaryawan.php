            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="username" name="nama_lengkap" value="<?php echo $nama_lengkap; ?>" required="required">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="phone" class="form-control" id="phone" name="no_hp" value="<?php echo $no_hp; ?>" required="required">
                    </div>
                </div>
                <div class="form-group">
